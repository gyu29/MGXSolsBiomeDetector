...
biome_colors = {"NORMAL": "ffffff", "SAND STORM": "F4C27C", "HELL": "5C1219", "STARFALL": "6784E0", "CORRUPTION": "9042FF", "NULL": "000000", "GLITCHED": "65FF65", "WINDY": "91F7FF", "SNOWING": "C4F5F6", "RAINY": "4385FF", "DREAMSPACE": "ff7dff"}
started = False
stopped = False
destroyed = False
debug_window = False
                ...
                if '"command":"SetRichPresence"' in line:
                    try:
                        ...
                        if json_data_start != -1:
                            ...
                            # Handle SNOWY biome by renaming it to SNOWING
                            if event == "SNOWY":
                                event = "SNOWING"
                            ...
                            if event and event != last_event:
                                if multi_webhook.get() != "1":
                                    ...
                                    # Send message when biome starts (any biome except NORMAL)
                                    if event != "NORMAL":
                                    ...
                                    # Send message when biome ends (transition to NORMAL)
                                    elif event == "NORMAL" and last_event is not None:
